# 👋 Olá, eu sou o Alexandre Gayer

🎯 Desenvolvedor apaixonado por criar soluções eficientes e escaláveis. Com foco principal em Flutter e Dart, tenho experiência sólida no desenvolvimento de aplicações móveis e web, sempre buscando as melhores práticas e inovações tecnológicas.

## 🚀 Tecnologias & Especialidades

- **Mobile:** Flutter, Dart
- **Web:** Vue.js, HTML5, CSS3, JavaScript
- **Backend:** Node.js, Firebase
- **Outras:** Git, GitHub, APIs RESTful, CI/CD
...
*Este README foi criado para destacar minhas habilidades e projetos. Sinta-se à vontade para explorar meus repositórios e entrar em contato para colaborações!*
